...
class FPNPyramid(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.last_bn_layer = nn.BatchNorm1d(in_channels)
    ...
    def forward(self, x): #(256, 7, 432)
        ...
        output = self.last_bn_layer(output)
        output = self.last_activation_layer(output)
...
if __name__ == "__main__":
    ...
    # Example usage
    B, T, C = 256, 432, 7  # Batch size, sequence length, number of channels
